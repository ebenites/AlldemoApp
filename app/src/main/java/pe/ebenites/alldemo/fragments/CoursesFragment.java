...
public class CoursesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter.addFragment(CoursesBoxFragment.newInstance(), getString(R.string.tab_title_box));
        adapter.addFragment(CoursesStoreFragment.newInstance(), getString(R.string.tab_title_store));
