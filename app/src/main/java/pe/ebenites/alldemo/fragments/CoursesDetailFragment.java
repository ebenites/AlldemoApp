...
public class CoursesDetailFragment extends Fragment {
    ...
    private static final String TAG = CoursesDetailFragment.class.getSimpleName();
    ...
    public static Fragment newInstance(Integer id, String title){
        Fragment fragment = new CoursesDetailFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_courses_detail, container, false);
    ...
    public void initialize(){
        ...
        ApiServiceGenerator.createService(getContext(), ApiService.class).getMyCoursesDetail(id).enqueue(new Callback<Course>() {
            @Override
...
//                        Picasso.with(context).load(url).into(viewHolder.logoImage);
                    ...
                    adapter.setLessons(course.getLessons());
