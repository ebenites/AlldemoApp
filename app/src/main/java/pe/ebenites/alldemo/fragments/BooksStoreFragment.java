...
import pe.ebenites.alldemo.adapters.BooksStoreRVAdapter;
...
public class BooksStoreFragment extends Fragment {
    ...
    public static Fragment newInstance(){
        Fragment fragment = new BooksStoreFragment();
        return fragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_books_store, container, false);
        ...
        recyclerView.setAdapter(new BooksStoreRVAdapter(this));
    ...
    public void initialize(){
        ...
        ApiServiceGenerator.createService(getContext(), ApiService.class).getBooks().enqueue(new Callback<List<Book>>() {
            @Override
            public void onResponse(@NonNull Call<List<Book>> call, @NonNull Response<List<Book>> response) {
                try {
                    ...
                    BooksStoreRVAdapter adapter = (BooksStoreRVAdapter) recyclerView.getAdapter();
    ...
    public void buy(final Book book) {
        ...
        /*new AlertDialog.Builder(getContext())
                ...
                .setMessage(getString(R.string.app_buy_dialog_message, book.getName()))
        ...
        new SweetAlertDialog(getContext(), SweetAlertDialog.CUSTOM_IMAGE_TYPE)
                ...
                .setContentText(getString(R.string.app_buy_dialog_message, book.getTitle()))
...
//                                .showContentText(false)
                        ...
                        ApiServiceGenerator.createService(getContext(), ApiService.class).checkoutBooks(book.getId()).enqueue(new Callback<ResponseSuccess>() {
                            @Override
                                                ...
                                                public void onClick(SweetAlertDialog sweetAlertDialog) {
                                                    ...
                                                    if(container instanceof ViewPager){
                                                        ...
                                                        if(viewPagerAdapter != null) {
                                                            ...
                                                            if (fragment instanceof BooksBoxFragment){
                                                                ((BooksBoxFragment)fragment).initialize();
                                                            }
                                                        }
                                                    }
